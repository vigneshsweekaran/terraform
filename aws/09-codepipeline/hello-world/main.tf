resource "aws_iam_role" "codepipeline_role" {
  name = "helloworld-codepipeline-role"
...
resource "aws_codepipeline" "codepipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ProjectName = aws_codebuild_project.hello-world.name
      }
    }
  }
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ApplicationName = aws_codedeploy_app.hello-world.name
