...
resource "aws_iam_policy" "AWSLoadBalancerControllerIAMPolicy" {
  name   = join("-", [var.cluster_name, "AWSLoadBalancerControllerIAMPolicy"])
  policy = <<POLICY
{
    "Version": "2012-10-17",
    "Statement": [
...
resource "aws_iam_role" "AmazonEKSLoadBalancerControllerRole" {
  name        = join("-", [var.cluster_name, "AmazonEKSLoadBalancerControllerRole"])
...
resource "aws_iam_role_policy_attachment" "AWSLoadBalancerControllerIAMPolicyRoleAttachment" {
